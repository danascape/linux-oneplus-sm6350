...
#elif defined(UFS3V0) || defined(UFS2V1)
...
static int ufshcd_complete_dev_init(struct ufs_hba *hba)
{
	...
	while (1) {
		...
		/*
		 * Poll for this flag in a tight loop for first 1500 iterations.
...
#if defined(CONFIG_UFSFEATURE) && (defined(UFS3V0) || defined(UFS2V1))
